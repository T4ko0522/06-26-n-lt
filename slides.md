...
<div class="section-label">04 — 問題提起</div>
...
<div class="section-label">05 — コンセプト</div>
...
似た立ち位置のサービスに **Cachix**, **niks3** などの SaaS 型 binary cache がある。cf-edgeNix の差別化点は:
...
<div style="display: flex; flex-direction: column; align-items: center; gap: 0.6rem; color: var(--c-text); font-size: 0.9rem">
  <div style="display: flex; align-items: center; gap: 0.5rem">
    <img src="/x-logo.svg" alt="X" style="height: 1rem; width: auto" />
    <span>@t4ko0522</span>
  </div>
  <div style="display: flex; align-items: center; gap: 0.5rem">
    <img src="/github-logo.svg" alt="GitHub" style="height: 1rem; width: auto" />
    <span>t4ko0522</span>
  </div>
  <div style="display: flex; align-items: center; gap: 0.5rem">
    <img src="/mail-logo.svg" alt="Email" style="height: 1rem; width: auto" />
    <span>tako.work.contact@gmail.com</span>
  </div>
  <div style="display: flex; align-items: center; gap: 0.5rem">
    <img src="/website-icon.png" alt="Website" style="height: 1rem; width: auto; border-radius: 3px" />
    <span>t4ko.pet</span>
  </div>
</div>

<div style="position: absolute; left: 0; right: 0; bottom: 1.5rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem; color: var(--c-text); font-size: 0.8rem">
  <span>powered by</span>
  <img src="/netlify-logo.svg" alt="Netlify" style="height: 1rem; width: auto" />
  <span>Netlify</span>
  <span style="color: var(--c-text-dim)">✕</span>
  <img src="/slidev-logo.svg" alt="Slidev" style="height: 1rem; width: auto" />
  <span>Slidev</span>
</div>
